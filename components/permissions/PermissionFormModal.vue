          ...
          <form @submit.prevent="handleSubmit">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <div>
                ...
                <p class="text-sm text-gray-400 mt-0.5">Define a module-level permission</p>
              </div>
            ...
            <div class="px-6 py-5 space-y-4">
              ...
              <div>
                ...
                <input v-model="form.module" type="text" required class="input" placeholder="e.g. Employees" />
              </div>

              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1.5">Action *</label>
                <select v-model="form.action" required class="input bg-white">
...
const handleSubmit = async () => {
  ...
  const result = await permissionsStore.createPermission({
