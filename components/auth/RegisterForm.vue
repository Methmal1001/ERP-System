<template>
  <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
    <div class="text-center mb-8">
      ...
      <p class="text-sm text-gray-400 mt-1">Join the HR Suite workspace</p>
    </div>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div>
        <label class="block text-xs font-medium text-gray-600 mb-1.5">
          Role ID
          <span class="text-gray-400 font-normal">(provided by your administrator)</span>
        </label>
        <div class="relative">
          <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 11-12 0 6 6 0 0112 0zM3 21l4.35-4.35" />
          </svg>
          <input
            v-model="roleId"
            type="text"
            ...
            class="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-colors font-mono"
          />
        </div>
        <p class="text-xs text-gray-400 mt-1.5">Ask an administrator for the Role ID assigned to your account from the Roles &amp; Permissions module.</p>
      </div>
